...
const Counter = () => {
  return (
    <Layout>
      <div className="px-8 xs:px-3 mt-12 md:mt-8 sm:mt-6 bg-counterBg w-full min-h-[500px] sm:min-h-[300px]">
        <div className="py-20">
          ...
          <div className="flex justify-center mt-10 cursor-pointer">
            <div className="h-3 w-3 relative flex justify-end ">
      ...
      <div className="px-12 md:px-10 sm:px-2 xs:px-6">
        <div className="px-20 xs:px-3 -mt-32 z-40  md:mt-8 sm:mt-6 bg-lightBlue py-20 md:py-10 rounded-lg">
